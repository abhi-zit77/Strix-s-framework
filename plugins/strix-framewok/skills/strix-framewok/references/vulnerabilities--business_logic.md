> Adapted and modified by abhi-zit77, 2026-09-22, from [usestrix/strix `strix/skills/vulnerabilities/business_logic.md`](https://github.com/usestrix/strix/blob/56e9ae982c2fdd00c7c0b9afc49af035470dd310/strix/skills/vulnerabilities/business_logic.md).
...
- **Invariant / expected secure behavior:** The business invariant survives reordered, replayed and malformed state transitions.
- **Execution and proof:** Document a legitimate synthetic workflow and show its invariant violated by a controlled alternate sequence.
...
- **Remediation when requested:** Enforce state-machine transitions, server-calculated values, ownership, atomicity and idempotency at the authoritative service.
