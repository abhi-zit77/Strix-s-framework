> Adapted and modified by abhi-zit77, 2026-09-22, from [usestrix/strix `strix/skills/vulnerabilities/nosql_injection.md`](https://github.com/usestrix/strix/blob/56e9ae982c2fdd00c7c0b9afc49af035470dd310/strix/skills/vulnerabilities/nosql_injection.md).
...
- **Invariant / expected secure behavior:** Untrusted values cannot change query operators, structure or authorization predicates.
- **Execution and proof:** Compare a legitimate query with controlled operator/type variants; demonstrate unexpected synthetic result selection.
...
- **Remediation when requested:** Build typed queries with allowed fields/operators and enforce tenant predicates independently of user selectors.
