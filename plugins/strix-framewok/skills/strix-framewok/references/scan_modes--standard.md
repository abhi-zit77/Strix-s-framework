> Adapted and modified by abhi-zit77, 2026-09-22, from [usestrix/strix `strix/skills/scan_modes/standard.md`](https://github.com/usestrix/strix/blob/56e9ae982c2fdd00c7c0b9afc49af035470dd310/strix/skills/scan_modes/standard.md).
...
# Standard assessment depth

Map supplied assets, roles and business flows before systematic tests. Use available source, AST, secrets and dependency passes or document gaps. Test applicable input, access, session and state-transition families with baseline/control pairs. Validate, report, and remediate only when requested.
