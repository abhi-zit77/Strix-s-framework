> Adapted and modified by abhi-zit77, 2026-09-22, from [usestrix/strix `strix/skills/vulnerabilities/subdomain_takeover.md`](https://github.com/usestrix/strix/blob/56e9ae982c2fdd00c7c0b9afc49af035470dd310/strix/skills/vulnerabilities/subdomain_takeover.md).
...
- **Invariant / expected secure behavior:** Referenced DNS/provider bindings remain controlled by the authorized owner.
- **Execution and proof:** Correlate DNS and provider state; treat banners as hypotheses and use only explicitly authorized ownership/canary checks.
...
- **Remediation when requested:** Remove dangling records or restore owned bindings; verify ownership before publishing routes.
