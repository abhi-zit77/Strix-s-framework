> Adapted and modified by abhi-zit77, 2026-09-22, from [usestrix/strix `strix/skills/vulnerabilities/browser_security.md`](https://github.com/usestrix/strix/blob/56e9ae982c2fdd00c7c0b9afc49af035470dd310/strix/skills/vulnerabilities/browser_security.md).
...
- **Invariant / expected secure behavior:** Origin, browsing context and message provenance constrain access to sensitive browser state.
- **Execution and proof:** Use separate controlled origins/contexts and demonstrate the specific message, navigation or state leak with canary data.
...
- **Remediation when requested:** Bind messages and navigation to allowed origins and contexts; configure isolation and service-worker scope appropriately.
