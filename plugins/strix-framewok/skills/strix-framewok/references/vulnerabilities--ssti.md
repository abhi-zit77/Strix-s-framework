> Adapted and modified by abhi-zit77, 2026-09-22, from [usestrix/strix `strix/skills/vulnerabilities/ssti.md`](https://github.com/usestrix/strix/blob/56e9ae982c2fdd00c7c0b9afc49af035470dd310/strix/skills/vulnerabilities/ssti.md).
...
- **Invariant / expected secure behavior:** Untrusted content remains template data and cannot select executable expressions.
- **Execution and proof:** Compare a literal baseline with harmless expression evaluation; fingerprint cautiously and prove server-side execution context.
...
- **Remediation when requested:** Keep templates trusted and bind untrusted values as data; restrict engine features and isolate rendering when required.
...
- Persistence risk: document the reachable write/execution boundary without installing persistence
