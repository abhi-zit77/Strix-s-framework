> Adapted and modified by abhi-zit77, 2026-09-22, from [usestrix/strix `strix/skills/vulnerabilities/semantic_confusion.md`](https://github.com/usestrix/strix/blob/56e9ae982c2fdd00c7c0b9afc49af035470dd310/strix/skills/vulnerabilities/semantic_confusion.md).
...
- **Invariant / expected secure behavior:** Every component interprets the security-relevant input with compatible semantics.
- **Execution and proof:** Run paired encodings/types/representations and show validated-versus-consumed disagreement at a real boundary.
...
- **Remediation when requested:** Canonicalize once before validation, reject ambiguity and bind validation to the exact object subsequently consumed.
