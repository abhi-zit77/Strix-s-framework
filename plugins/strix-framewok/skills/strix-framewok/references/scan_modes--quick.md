> Adapted and modified by abhi-zit77, 2026-09-22, from [usestrix/strix `strix/skills/scan_modes/quick.md`](https://github.com/usestrix/strix/blob/56e9ae982c2fdd00c7c0b9afc49af035470dd310/strix/skills/scan_modes/quick.md).
...
# Quick assessment depth

Prioritize supplied changes and critical authentication, authorization, injection, outbound fetch and secrets paths. Use tightly scoped source/AST and available scanner passes. Browse critical flows, validate high-signal candidates, and record omitted applicable techniques. Avoid broad enumeration.
