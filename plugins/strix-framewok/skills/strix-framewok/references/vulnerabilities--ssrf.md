> Adapted and modified by abhi-zit77, 2026-09-22, from [usestrix/strix `strix/skills/vulnerabilities/ssrf.md`](https://github.com/usestrix/strix/blob/56e9ae982c2fdd00c7c0b9afc49af035470dd310/strix/skills/vulnerabilities/ssrf.md).
...
- **Invariant / expected secure behavior:** Server-side fetches reach only authorized destinations across redirects and resolution.
- **Execution and proof:** Use a controlled callback or synthetic internal service; compare allowed and forbidden destinations and attribute requests to the server.
...
- **Remediation when requested:** Parse and constrain schemes/origins, validate resolved addresses and redirects, and apply egress controls at the request boundary.
