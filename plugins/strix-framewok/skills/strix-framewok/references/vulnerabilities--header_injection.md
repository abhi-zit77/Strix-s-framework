> Adapted and modified by abhi-zit77, 2026-09-22, from [usestrix/strix `strix/skills/vulnerabilities/header_injection.md`](https://github.com/usestrix/strix/blob/56e9ae982c2fdd00c7c0b9afc49af035470dd310/strix/skills/vulnerabilities/header_injection.md).
...
- **Invariant / expected secure behavior:** Attacker input cannot become header structure, trusted routing authority or shared-cache identity.
- **Execution and proof:** Compare benign and delimiter/forwarded-header cases using controlled responses; establish parser and cache behavior.
...
- **Remediation when requested:** Reject structural control characters, constrain trusted proxy headers and preserve correct cache/host boundaries.
