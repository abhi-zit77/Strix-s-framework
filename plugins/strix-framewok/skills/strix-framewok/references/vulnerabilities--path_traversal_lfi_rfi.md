> Adapted and modified by abhi-zit77, 2026-09-22, from [usestrix/strix `strix/skills/vulnerabilities/path_traversal_lfi_rfi.md`](https://github.com/usestrix/strix/blob/56e9ae982c2fdd00c7c0b9afc49af035470dd310/strix/skills/vulnerabilities/path_traversal_lfi_rfi.md).
...
- **Invariant / expected secure behavior:** File selection and extraction stay within the authorized canonical root and tenant.
- **Execution and proof:** Use a synthetic file outside the allowed root; compare ordinary, traversal and alternate encoded/absolute path inputs.
...
- **Remediation when requested:** Resolve paths and enforce containment before reads/writes; handle symlinks, archives, encodings and per-tenant roots.
