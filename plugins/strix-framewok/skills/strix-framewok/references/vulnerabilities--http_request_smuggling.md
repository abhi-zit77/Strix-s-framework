> Adapted and modified by abhi-zit77, 2026-09-22, from [usestrix/strix `strix/skills/vulnerabilities/http_request_smuggling.md`](https://github.com/usestrix/strix/blob/56e9ae982c2fdd00c7c0b9afc49af035470dd310/strix/skills/vulnerabilities/http_request_smuggling.md).
...
- **Invariant / expected secure behavior:** Intermediaries and origin agree on request boundaries and routing.
- **Execution and proof:** Use an isolated authorized connection and canary request pair; show differential framing without involving other users.
...
- **Remediation when requested:** Align and update HTTP parsers, reject ambiguous framing, and normalize protocols at one trusted boundary.
