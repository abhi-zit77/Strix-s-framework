> Adapted and modified by abhi-zit77, 2026-09-22, from [usestrix/strix `strix/skills/vulnerabilities/sql_injection.md`](https://github.com/usestrix/strix/blob/56e9ae982c2fdd00c7c0b9afc49af035470dd310/strix/skills/vulnerabilities/sql_injection.md).
...
- **Invariant / expected secure behavior:** Untrusted values cannot alter SQL syntax or escape the authorized row set.
- **Execution and proof:** Compare ordinary, true/false and alternate benign SQL-shaped inputs against synthetic data; rule out generic errors and caching.
...
- **Remediation when requested:** Parameterize values, allowlist structural identifiers and enforce tenant authorization independently of search filters.
