> Adapted and modified by abhi-zit77, 2026-09-22, from [usestrix/strix `strix/skills/vulnerabilities/rce.md`](https://github.com/usestrix/strix/blob/56e9ae982c2fdd00c7c0b9afc49af035470dd310/strix/skills/vulnerabilities/rce.md).
...
- **Invariant / expected secure behavior:** Untrusted input cannot trigger arbitrary process or code execution.
- **Execution and proof:** Trace the execution sink and use a harmless controlled marker in an isolated scope; record the identity and effect.
...
- **Remediation when requested:** Remove dynamic execution where possible; separate data from code and constrain executable, arguments, parsers and privileges.
