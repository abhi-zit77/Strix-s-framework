> Adapted and modified by abhi-zit77, 2026-09-22, from [usestrix/strix `strix/skills/vulnerabilities/information_disclosure.md`](https://github.com/usestrix/strix/blob/56e9ae982c2fdd00c7c0b9afc49af035470dd310/strix/skills/vulnerabilities/information_disclosure.md).
...
- **Invariant / expected secure behavior:** Only explicitly public data is available to an unprivileged principal.
- **Execution and proof:** Classify a synthetic restricted item and show unauthorized access; distinguish expected public metadata and redaction.
...
- **Remediation when requested:** Remove sensitive fields at the server boundary, constrain diagnostics and caches, and rotate genuinely exposed secrets through an authorized process.
