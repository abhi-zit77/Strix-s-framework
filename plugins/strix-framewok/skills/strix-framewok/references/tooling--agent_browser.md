> Adapted and modified by abhi-zit77, 2026-09-22, from [usestrix/strix `strix/skills/tooling/agent_browser.md`](https://github.com/usestrix/strix/blob/56e9ae982c2fdd00c7c0b9afc49af035470dd310/strix/skills/tooling/agent_browser.md).
...
Prefer the host browser tool (including Playwright/MCP) when available.
The CLI examples below apply only if agent-browser is installed and its
current help confirms them. Verify proxy configuration; there is no
automatic Caido environment in this skill. Use task-specific screenshot
paths returned by the host, not assumed Strix sandbox paths.
...
auth vault (see [tool-adaptation.md#browser-workflow](tool-adaptation.md#browser-workflow)):
...
Choose a writable private run directory and pass its explicit screenshot path.
...
See [tool-adaptation.md#browser-workflow](tool-adaptation.md#browser-workflow) for
...
survives browser restarts. See [tool-adaptation.md#browser-workflow](tool-adaptation.md#browser-workflow)
and [tool-adaptation.md#browser-workflow](tool-adaptation.md#browser-workflow).
...
instructed. Follow the scope and untrusted-content rules in tool-adaptation.md.

## Installed CLI documentation

Use the installed CLI help for command, authentication, proxy, recording and
session options. Upstream agent-browser companion references are not bundled here.
Use this package's tool-adaptation.md for host browser capabilities and evidence.
