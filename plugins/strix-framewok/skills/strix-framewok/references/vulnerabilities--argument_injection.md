> Adapted and modified by abhi-zit77, 2026-09-22, from [usestrix/strix `strix/skills/vulnerabilities/argument_injection.md`](https://github.com/usestrix/strix/blob/56e9ae982c2fdd00c7c0b9afc49af035470dd310/strix/skills/vulnerabilities/argument_injection.md).
...
- **Invariant / expected secure behavior:** User input remains data through every argv and secondary parser boundary.
- **Execution and proof:** Compare a benign argument with a harmless option-like input; capture actual argv/parsed behavior and controlled effect.
...
- **Remediation when requested:** Use fixed executables, explicit option boundaries and allowlisted arguments; inspect response-file and platform parsing.
