> Adapted and modified by abhi-zit77, 2026-09-22, from [usestrix/strix `strix/skills/vulnerabilities/weak_password_detection.md`](https://github.com/usestrix/strix/blob/56e9ae982c2fdd00c7c0b9afc49af035470dd310/strix/skills/vulnerabilities/weak_password_detection.md).
...
- **Invariant / expected secure behavior:** Authentication policy prevents unauthorized access and handles failed attempts safely.
- **Execution and proof:** Use approved synthetic accounts and bounded attempts; compare failed/successful baselines and account/rate controls.
...
- **Remediation when requested:** Enforce effective password, MFA, throttling and recovery policy; eliminate defaults without disabling legitimate recovery.
