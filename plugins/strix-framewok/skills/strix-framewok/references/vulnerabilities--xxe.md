> Adapted and modified by abhi-zit77, 2026-09-22, from [usestrix/strix `strix/skills/vulnerabilities/xxe.md`](https://github.com/usestrix/strix/blob/56e9ae982c2fdd00c7c0b9afc49af035470dd310/strix/skills/vulnerabilities/xxe.md).
...
- **Invariant / expected secure behavior:** Untrusted XML cannot resolve external entities or access unauthorized resources.
- **Execution and proof:** Use a synthetic local marker or controlled callback; distinguish parser rejection from safe parsing and verify the affected factory.
...
- **Remediation when requested:** Disable external entities/DTD resolution as appropriate, configure all parser factories and enforce resource limits.
